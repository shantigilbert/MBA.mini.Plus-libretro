...
ROM_START( sk2h3 ) // same as MAME sgyxz - here until it gets fixed. In FBA, its name is sgyxz, too. 
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_BYTE( "sgyxz_prg2.bin", 0x000000, 0x20000, CRC(95429c83) SHA1(e981624d018132e5625a66113b6ac4fc44e55cf7) )
	ROM_CONTINUE( 0x80000, 0x20000 )
	ROM_CONTINUE( 0x40000, 0x20000 )
...
GAME( 200?, sk2h1,       wof,      sgyxz,      sgyxz,     wofh,    ROT0,   "All-In Co Ltd", "Sangokushi II (Chinese bootleg set 6, 921005 Asia)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h2,       wof,      sgyxz,      sgyxz,     wofh,    ROT0,   "All-In Co Ltd", "Sangokushi II (Chinese bootleg set 7, 921005 Asia)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h3,       wof,      sgyxz,      sgyxz,     sgyxz,    ROT0,   "All-In Co Ltd", "Sangokushi II (set H3)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h22,      wof,      sgyxz,      wof3js,    wofsj,   ROT0,   "Unknown", "San Jian Sheng (Chinese bootleg set 2, 921005 Asia)", GAME_SUPPORTS_SAVE )
GAME( 2018, sk3h1,       wof,      sgyxz,      sgyxz,     wofh,    ROT0,   "Unknown", "Sangokushi 3 (San Guo Ying Xiong Zhuan Plus)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, wofh04,        wof,      sgyxz,      sgyxz,       wofh,    ROT0,   "Katana", "Sangokushi II (Heroes Of The Three Kingdoms)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, wofh05,        wof,      sgyxz,      sgyxz,       wofh,    ROT0,   "Katana", "Sangokushi II (Heroes of the Three Kingdoms Repair SP)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, wofh06,        wof,      sgyxz,      sgyxz,       wofh,    ROT0,   "winux", "Sangokushi II (Full Level Boss Special Edition)(2006/04/13)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, wofh07,        wof,      sgyxz,      sgyxz,       wofh,    ROT0,   "winux", "Sangokushi II (Zhao Yun’s Attack Is Strengthened)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, wofh08,        wof,      sgyxz,      sgyxz,       wofh,    ROT0,   "winuxx", "Sangokushi II (The Revised Version Of The Invincible And Zhao Yun Greatly Enhanced Version Of The Attack)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h31,      wof,      wofsj,		wofsj,		wofsj,   ROT0,   "Gen Gan San Go", "Sangokushi II (Chinese bootleg set 1, 921005 Asia)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h32,      wof,      wofsj,		wofsj,		wofsj,   ROT0,   "Gen Gan San Go", "Sangokushi II (Chinese bootleg set 2, 921005 Asia)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h33,      wof,      wofsj,		wofsj,		wofsj,   ROT0,   "Gen Gan San Go", "Sangokushi II (Chinese bootleg set 9, 921005 Asia)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h34,      wof,      wofsj,		wofsj,		wofsj,   ROT0,   "Gen Gan San Go", "Sangokushi II (Chinese bootleg set 8, 921005 Asia)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h42,        wof,      sgyxz,      wof3js,      wofsj,   ROT0,   "Unknown", "San Jian Sheng (Correct Zhao Yun Weapon Title Background BUG)(Chinese bootleg of Sangokushi II)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h43,        wof,      wofsj,		wofsj,		wofsj,   ROT0,   "Unknown", "Sangokushi II (Chinese bootleg set 4, 921005 Asia)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h46,        wof,      wofsj,		wofsj,		wofsj,   ROT0,   "Unknown", "Sangokushi II (Holy Swords)(Asia 921005)", GAME_SUPPORTS_SAVE )
...
sk2h22 = wof3jsa
sk2h31 = wof3sj
sk2h31q = wof3sj & Q-Sound
*/

/* 
static ADDRESS_MAP_START( sk2h1q_map, ADDRESS_SPACE_PROGRAM, 16 )
	AM_RANGE(0x000000, 0x3fffff) AM_ROM
	AM_RANGE(0x800030, 0x800031) AM_WRITE(cps1_coinctrl_w)
	AM_RANGE(0x800100, 0x80013f) AM_RAM AM_BASE_MEMBER(cps_state, cps_a_regs)
	AM_RANGE(0x800140, 0x80017f) AM_READWRITE(cps1_cps_b_r, cps1_cps_b_w) AM_BASE_MEMBER(cps_state, cps_b_regs)
...
static ADDRESS_MAP_START( sk2h31q_map, ADDRESS_SPACE_PROGRAM, 16 )
	AM_RANGE(0x000000, 0x3fffff) AM_ROM
	AM_RANGE(0x800030, 0x800031) AM_WRITE(cps1_coinctrl_w)
	AM_RANGE(0x800100, 0x80013f) AM_WRITE(cps1_cps_a_w)  AM_BASE_MEMBER(cps_state, cps_a_regs)
	AM_RANGE(0x800140, 0x80017f) AM_READWRITE(cps1_cps_b_r, cps1_cps_b_w) AM_BASE_MEMBER(cps_state, cps_b_regs)
	AM_RANGE(0x880000, 0x880001) AM_READ_PORT("IN1")
	AM_RANGE(0x880006, 0x880007) AM_WRITENOP
	AM_RANGE(0x880008, 0x88000f) AM_READ(cps1_dsw_r)
	AM_RANGE(0x880e7e, 0x880e7f) AM_READ(cps1_in2_r)
	AM_RANGE(0x890000, 0x890001) AM_WRITENOP
	AM_RANGE(0x8bfff6, 0x8bfff9) AM_READNOP
	AM_RANGE(0x900000, 0x92ffff) AM_RAM_WRITE(cps1_gfxram_w) AM_BASE_SIZE_MEMBER(cps_state, gfxram, gfxram_size)
	AM_RANGE(0xf18000, 0xf19fff) AM_READWRITE(qsound_sharedram1_r, qsound_sharedram1_w)
...
static ADDRESS_MAP_START( wofsf2_map, ADDRESS_SPACE_PROGRAM, 16 )
	AM_RANGE(0x000000,0x3fffff) AM_ROM
	AM_RANGE(0x800000,0x800007) AM_READ_PORT("IN1")
	...
	AM_RANGE(0x900000,0x92ffff) AM_RAM_WRITE(cps1_gfxram_w)  AM_BASE_SIZE_MEMBER(cps_state, gfxram, gfxram_size)
	AM_RANGE(0xf18000,0xf19fff) AM_RAM  //maybe AM_RAM AM_BASE_MEMBER(cps_state, mainram)
	AM_RANGE(0xf1c000,0xf1c001) AM_READ(cps1_in2_r)
	AM_RANGE(0xf1c004,0xf1c005) AM_WRITE(cpsq_coinctrl2_w)
	AM_RANGE(0xf1c006,0xf1c007) AM_READ_PORT("EEPROMIN") AM_WRITE_PORT("EEPROMOUT")
	AM_RANGE(0xff0000,0xffffff) AM_RAM AM_BASE_MEMBER(cps_state, mainram) //.ram().share("mainram");
ADDRESS_MAP_END
...
MACHINE_CONFIG_START( cps_state::sk2h1q )
	...
	MCFG_DEVICE_VBLANK_INT_DRIVER("screen",  cps1_interrupt)
	MCFG_DEVICE_IRQ_ACKNOWLEDGE_DRIVER( cps1_int_ack)
	...
	MCFG_DEVICE_PERIODIC_INT_DRIVER( irq0_line_hold, 250)    //

	MCFG_MACHINE_START_OVERRIDE( qsound)
...
/*
GAME( 200?, wofsf2,      wof,      wofsf2,     wof,       cps1,     ROT0,   "Unknown", "Warriors of Fate (conversion for SF2 HW)(World 921031)", GAME_SUPPORTS_SAVE )

GAME( 200?, sk2h31q,     wof,      sk2h31q,    wof3sj,    wof3sj,   ROT0,   "Gen Gan San Go", "Sangokushi II (set H31Q)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h32q,     wof,      sk2h31q,    wof3sj,    wof3sj,   ROT0,   "Gen Gan San Go", "Sangokushi II (set H32Q)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h33q,     wof,      sk2h31q,    wof3sj,    wof3sj,   ROT0,   "Gen Gan San Go", "Sangokushi II (set H33Q)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h34q,     wof,      sk2h31q,    wof3sj,    wof3sj,   ROT0,   "Gen Gan San Go", "Sangokushi II (set H34Q)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h1q,      wof,      sk2h1q,     wofh,     sk2h1q,   ROT0,   "All-In Co Ltd", "Sangokushi II (set H1Q)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h2q,      wof,      sk2h1q,     wofh,     sk2h1q,   ROT0,   "All-In Co Ltd", "Sangokushi II (set H2Q)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h4q,      wof,      sk2h1q,     wofh,     sk2h1q,   ROT0,   "All-In Co Ltd", "Sangokushi II (set H4Q)(Chinese v2.0)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 2009, sk2h5q,      wof,      sk2h1q,     wofh,     sk2h1q,   ROT0,   "Winuxx", "Sangokushi II (Revised Version)(2009-09-09)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 2006, sk2h6q,      wof,      sk2h1q,     wofh,     sk2h1q,   ROT0,   "Winuxx", "Sangokushi II (Full Level Boss Final)(2006-01-29)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h7,         wof,      sk2h1q,     wofh,       sk2h1q,   ROT0,   "Unknown", "Sangokushi II (Description Of Unknown Origin HH 01)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk2h8,         wof,      sk2h1q,     wofh,       sk2h1q,   ROT0,   "Unknown", "Sangokushi II (Description Of Unknown Origin HH 02)(Asia 921005)", GAME_SUPPORTS_SAVE )
GAME( 200?, sk3h2,         wof,      sk2h1q,     wofh,       sk2h1q,   ROT0,   "Unknown", "Sangokushi 3 (The Three Kingdoms III Part 1: Heroes of the Three Kingdoms)(Asia 921005)", GAME_SUPPORTS_SAVE )
*/
