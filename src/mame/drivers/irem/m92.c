...
// Ported to MBA-mini Plus By SumavisionQ5(GXB) on 2019-05-16.
...
ROM_START( hooks01 )
	...
	ROM_REGION( 0x100000, "soundcpu", 0 ) // All "ROM_REGION( 0x20000, "soundcpu", 0 )" were replaced.
	ROM_LOAD16_BYTE( "h-sh0-a.3l", 0x00001, 0x10000, CRC(bd3d1f61) SHA1(0c884a0b5519f9c0823128872baf7b0c4078e5c4) )
	ROM_LOAD16_BYTE( "h-sl0-a.3n", 0x00000, 0x10000, CRC(76371def) SHA1(b7a86fd4eecdd8a538c32e08cd920c27bd50924b) )
...
ROM_START( nbbatmans01 )
	ROM_REGION( 0x180000, "maincpu", 0 ) //ROM_REGION( 0x100000, "maincpu", 0 )
...
// Guardians
GAME( 2016, hooks01,     hook,        hook,          hook,      m92_most,	ROT0,   "Unknown",         "Hook (1V4 2016-06-25)", GAME_SUPPORTS_SAVE )
GAME( 2018, hooks02,     hook,        hook,          hook,      m92_most,	ROT0,   "Unknown",         "Hook (Zinc Children's Edition Update 2018-05-15)", GAME_SUPPORTS_SAVE )
GAME( 2018, hooks03,     hook,        hook,          hook,      m92_most,	ROT0,   "Unknown",         "Hook (Zinc Children's Edition Update 2018-05-02)", GAME_SUPPORTS_SAVE )
GAME( 2018, hooks04,     hook,        hook,          hook,      m92_most,	ROT0,   "Unknown",         "Hook (X2 Edition 2018-05-05)", GAME_SUPPORTS_SAVE )
GAME( 1992, hooks05,     hook,        hook,          hook,      m92_most,	ROT0,   "RockyWall",       "Hook (Can Be Substituted For Character)", GAME_SUPPORTS_SAVE )
GAME( 2016, hooks06,     hook,        hook,          hook,      m92_most,	ROT0,   "RockyWall",       "Hook (Unrivalled Version 2016-08-18)", GAME_SUPPORTS_SAVE )
GAME( 1992, hookus01,    hook,        hook,          hook,      m92_most,	ROT0,   "Unknown",         "Hook (plus)", GAME_SUPPORTS_SAVE )
GAME( 2016, hookus02,    hook,        hook,          hook,      m92_most,	ROT0,   "RockyWall",       "Hook (Iron hook unparalleled 2016-07-31)", GAME_SUPPORTS_SAVE )
GAME( 2018, hookxr,      hook,        hook,          hook,      m92_most,	ROT0,   "Unknown",         "Hook (Zinc Children's Edition Update 2018-09-14)", GAME_SUPPORTS_SAVE )
// Ninja Baseball Bat Man
GAME( 2018, nbbatmans01, nbbatman,    nbbatman,      nbbatman,  m92_gunforc2,  ROT0,   "Unknown",         "Ninja Baseball Bat Man (X2 Edition 2018-05-05)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE )
GAME( 2017, nbbatmans02, nbbatman,    nbbatman,      nbbatman,  m92_gunforc2,  ROT0,   "Unknown",         "Ninja Baseball Bat Man (1V4 2017-03-15)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE )
GAME( 2013, nbbatmanus01,nbbatman,    nbbatman,      nbbatman,  m92_gunforc2,  ROT0,   "Unknown",         "Ninja Baseball Bat Man (Unknown Hack 2013-06-04)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE)
GAME( 2016, nbbatmanus02,nbbatman,    nbbatman,      nbbatman,  m92_gunforc2,  ROT0,   "Unknown",         "Ninja Baseball Bat Man (New Starter Edition Update 2016-10-16)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE)
GAME( 2019, nbbatmanus03,nbbatman,    nbbatman,      nbbatman,  m92_gunforc2,  ROT0,   "Unknown",         "Ninja Baseball Bat Man (Musou version 2019-02-23)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE)
GAME( 2016, nbbatmanus04,nbbatman,    nbbatman,      nbbatman,  m92_gunforc2,  ROT0,   "Unknown",         "Ninja Baseball Bat Man (Characters Changeable 2016-12-03)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE)
GAME( 2019, nbbatmanus05,nbbatman,    nbbatman,      nbbatman,  m92_gunforc2,  ROT0,   "Unknown",         "Ninja Baseball Bat Man (Musou Edition 2019-03-08)", GAME_IMPERFECT_GRAPHICS | GAME_SUPPORTS_SAVE)
